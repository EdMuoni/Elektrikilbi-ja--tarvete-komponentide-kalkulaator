...
namespace ElektriKalkulaator.Data
{
    ...
    public class ElektriKalkulaatorContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private void SeedProducts(ModelBuilder mb)
        {
            ...
            // ImagePath points at real, freely-licensed photographs stored in
            // wwwroot/images/products (all .jpg, one format for the whole catalogue).
            // These are genuine photos of the CORRECT COMPONENT TYPE, but not of these exact
            ...
            mb.Entity<Product>().HasData(
                ...
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000001"), CategoryId = cat1, Name = "ABB S201-B10 Kaitselüliti 10A",  Brand = "ABB",       RatedCurrent = 10, Voltage = 230, Price = 8.50m,  StockQuantity = 150,  WireCrossSectionMm2 = 1.5m, ImagePath = "/images/products/breaker.jpg", Description = "1-pooluseline kaitselüliti B10A, 6kA", CreatedAt = now, ModifiedAt = now },
                // Breakers — 16A (sockets)
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000002"), CategoryId = cat1, Name = "ABB S201-B16 Kaitselüliti 16A",  Brand = "ABB",       RatedCurrent = 16, Voltage = 230, Price = 9.20m,  StockQuantity = 200,  WireCrossSectionMm2 = 2.5m, ImagePath = "/images/products/breaker.jpg", Description = "1-pooluseline kaitselüliti B16A, 6kA", CreatedAt = now, ModifiedAt = now },
                // Breakers — 32A (stove)
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000003"), CategoryId = cat1, Name = "ABB S201-B32 Kaitselüliti 32A",  Brand = "ABB",       RatedCurrent = 32, Voltage = 230, Price = 12.80m, StockQuantity = 80,   WireCrossSectionMm2 = 6.0m, ImagePath = "/images/products/breaker.jpg", Description = "1-pooluseline kaitselüliti B32A, 6kA", CreatedAt = now, ModifiedAt = now },
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000004"), CategoryId = cat1, Name = "Schneider Easy9 B10A",           Brand = "Schneider", RatedCurrent = 10, Voltage = 230, Price = 7.90m,  StockQuantity = 120,  WireCrossSectionMm2 = 1.5m, ImagePath = "/images/products/breaker.jpg", Description = "1-pooluseline kaitselüliti B10A",      CreatedAt = now, ModifiedAt = now },
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000005"), CategoryId = cat1, Name = "Schneider Easy9 B16A",           Brand = "Schneider", RatedCurrent = 16, Voltage = 230, Price = 8.50m,  StockQuantity = 180,  WireCrossSectionMm2 = 2.5m, ImagePath = "/images/products/breaker.jpg", Description = "1-pooluseline kaitselüliti B16A",      CreatedAt = now, ModifiedAt = now },
                // Cables — sold by the metre
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000006"), CategoryId = cat2, Name = "NYM-J 3x1.5mm² kaabel (1m)",    Brand = "Draka",     RatedCurrent = 10, Voltage = 230, Price = 1.20m,  StockQuantity = 5000, WireCrossSectionMm2 = 1.5m, ImagePath = "/images/products/cable.jpg",   Description = "Valgustuse juhe, müüakse meetrites",   CreatedAt = now, ModifiedAt = now },
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000007"), CategoryId = cat2, Name = "NYM-J 3x2.5mm² kaabel (1m)",    Brand = "Draka",     RatedCurrent = 16, Voltage = 230, Price = 1.85m,  StockQuantity = 5000, WireCrossSectionMm2 = 2.5m, ImagePath = "/images/products/cable.jpg",   Description = "Pistikute juhe, müüakse meetrites",    CreatedAt = now, ModifiedAt = now },
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000008"), CategoryId = cat2, Name = "NYM-J 3x6mm² kaabel (1m)",      Brand = "Draka",     RatedCurrent = 32, Voltage = 230, Price = 3.60m,  StockQuantity = 2000, WireCrossSectionMm2 = 6.0m, ImagePath = "/images/products/cable.jpg",     Description = "Pliidi juhe, müüakse meetrites",       CreatedAt = now, ModifiedAt = now },
                // RCD
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000009"), CategoryId = cat3, Name = "ABB F202 AC-40/0.03 RCD 40A",   Brand = "ABB",       RatedCurrent = 40, Voltage = 230, Price = 42.00m, StockQuantity = 50,   ImagePath = "/images/products/rcd.jpg",         Description = "2-pooluseline rikkevoolukaitsme 40A 30mA",  CreatedAt = now, ModifiedAt = now },
                // Enclosure
                new Product { Id = Guid.Parse("22222222-0000-0000-0000-000000000010"), CategoryId = cat5, Name = "ABB Mistral41F 12 mooduli kilp", Brand = "ABB",       RatedCurrent = 0,  Voltage = 230, Price = 28.50m, StockQuantity = 30,   ImagePath = "/images/products/enclosure.jpg",   Description = "Pinna-paigaldusega kilbi korpus 12 moodulile", CreatedAt = now, ModifiedAt = now }
            );
        }
